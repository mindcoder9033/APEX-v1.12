...
export const Home: React.FC = () => {
  return (
    <div className="space-y-10">
      {/* Hero Section */}
      <section className="bg-[#121216] border border-[#262630] rounded-xl p-8 sm:p-12 relative overflow-hidden">
        <div className="absolute -right-12 -top-12 w-64 h-64 bg-[#E10600]/5 rounded-full blur-3xl pointer-events-none" />
        <div className="max-w-3xl space-y-6 relative z-10">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[#F3F4F6] font-sans">
            Transforming Beginners Into <span className="text-[#E10600]">Disciplined Sim Racers</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link to="/dashboard">
              <Button size="lg" className="gap-2 shadow-[0_0_15px_rgba(225,6,0,0.35)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card accentBorder className="space-y-4">
            <div className="flex justify-between items-start">
              <span className="text-xs font-mono text-[#E10600] font-bold">STAGE 01</span>
            ...
            <div className="bg-[#1A1A20] p-3 rounded-lg text-xs font-mono text-[#9CA3AF] space-y-1.5 border border-[#262630]">
      ...
      <section className="bg-[#121216] border border-[#262630] rounded-xl p-8 space-y-6">
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="space-y-2">
            <div className="w-8 h-8 rounded-md bg-[#E10600]/10 text-[#E10600] flex items-center justify-center font-bold">1</div>
          ...
          <div className="space-y-2">
            <div className="w-8 h-8 rounded-md bg-[#3B82F6]/10 text-[#3B82F6] flex items-center justify-center font-bold">2</div>
          ...
          <div className="space-y-2">
            <div className="w-8 h-8 rounded-md bg-[#FFB800]/10 text-[#FFB800] flex items-center justify-center font-bold">3</div>
          ...
          <div className="space-y-2">
            <div className="w-8 h-8 rounded-md bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold">4</div>
