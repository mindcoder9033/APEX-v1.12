...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header Banner */}
      <div className="flex flex-wrap items-center justify-between gap-4 bg-[#12151E] border border-[#262C3D] rounded-xl p-6 relative overflow-hidden">
        <div className="absolute right-0 top-0 w-80 h-full bg-[#00E599]/5 rounded-r-xl pointer-events-none blur-2xl" />
        <div className="space-y-1 relative z-10">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-[#F3F4F6] font-sans tracking-tight">
            Academy Command <span className="text-[#00E599]">Dashboard</span>
          </h1>
      ...
      {/* Tab Navigation */}
      <div className="flex items-center border-b border-[#262C3D] gap-2 font-mono text-xs">
        <button
      ...
      {activeTab === 'ANALYTICS' && (
        <div className="space-y-6">
          ...
          <Card className="bg-[#12151E] border-[#262C3D] p-6 space-y-4">
            <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 font-mono text-xs">
              <div className="bg-[#1A1E2B] p-3 rounded border border-[#262C3D]">
                <span className="text-[#9CA3AF] block">Target Consistency:</span>
                <span className="text-[#00E599] font-bold text-sm">&lt; 1.00s Delta</span>
              </div>
              <div className="bg-[#1A1E2B] p-3 rounded border border-[#262C3D]">
