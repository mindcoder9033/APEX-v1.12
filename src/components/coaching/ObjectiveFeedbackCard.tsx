...
export const ObjectiveFeedbackCard: React.FC<ObjectiveFeedbackProps> = ({
  ...
  return (
    <Card accentBorder={passed} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 py-2 border-y border-[#262C3D] font-mono">
        <div className="p-3 bg-[#1A1E2B] rounded border border-[#262C3D]">
          <span className="text-xs text-[#9CA3AF] block font-sans uppercase">Avg Lap Delta</span>
          <span className={`text-lg font-bold ${lapDeltaSeconds <= 0.5 ? 'text-[#00E599]' : 'text-[#FFB800]'}`}>
        ...
        <div className="p-3 bg-[#1A1E2B] rounded border border-[#262C3D]">
          ...
          <span className={`text-lg font-bold ${brakeReleaseVariance <= 5 ? 'text-[#00E599]' : 'text-[#FF3B30]'}`}>
        ...
        <div className="p-3 bg-[#1A1E2B] rounded border border-[#262C3D]">
          ...
          <span className={`text-lg font-bold ${apexDeviationCm <= 30 ? 'text-[#00E599]' : 'text-[#FFB800]'}`}>
            {apexDeviationCm} cm
          </span>
      ...
      <div className="p-3 bg-[#1A1E2B]/80 rounded border border-[#262C3D] text-sm">
        <span className="text-xs font-mono uppercase text-[#00E599] font-bold block mb-1">
